...
By utilizing **OpenRouter** as a secondary gateway for the Meta/Llama suite, the framework provides a resilient failover mechanism that bypasses provider-specific rate limits and authentication hurdles.
...
* To begin a full audit run (121 prompts per model): `python3 main.py`
